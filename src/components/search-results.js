...
export default {
  ...
  template: `
  <div class="block" >
        <span v-if="getResults.length > 0 ">{{indexStart}} - {{indexEnd}} of {{getResults.length}} results</span>
  ...
  <ul class="list-reset bg-white p-4 border border-solid border-grey-light">
    ...
    <div class="max-w-lg p-36 container flex justify-center mx-auto">
  <div class="flex flex-row mx-auto">
    <button type="button" class="bg-gray-800 text-white rounded-l-md border-r border-gray-100 py-2 hover:bg-red-700 hover:text-white px-3" @click="prev">
    ...
    <button type="button" class="bg-gray-800 text-white rounded-r-md py-2 border-l border-gray-200 hover:bg-red-700 hover:text-white px-3" @click="next()">
      <div class="flex flex-row align-middle">
